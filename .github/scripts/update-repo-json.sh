...
BUILD_JSON=MacroMate/bin/x64/ReleaseAlpha/MacroMateAlpha.json
...
VERSION_URL="https://github.com/grittyfrog/MacroMate/releases/download/v${BUILD_VERSION}/MacroMateAlpha.zip"
